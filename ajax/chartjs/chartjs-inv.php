...
FROM covid_amount_head_inventory_r4 cah where cah.crvinventoryr4_head_date = '$St_date'
ORDER BY cah.crvinventoryr4_head_date  ASC ";
...
$db_r4->exec("set names utf8");
 ...
 $list_date[$num_static]= thai_date_fullmonth(strtotime($rs_value['crvinventoryr4_head_date']));

$CohortWard[$num_static] = $rs_value["CohortWard"];
	
$BedEmpty[$num_static] = $rs_value["BedEmpty"];

$Aiir[$num_static]	= $rs_value["Aiir"];

$ModifiedAirr[$num_static] = $rs_value["ModifiedAirr"];

$icu_covid[$num_static] = $rs_value["icu_covid"];

$Isolationroom[$num_static] = $rs_value["Isolationroom"];

$Respirator[$num_static] = $rs_value["Respirator"];
        ...
        <table class="table table-bordered" style="background-color: white;">
        	...
        	<thead>
        		<tr>
        			<th>อันดับ</th>
        			<th>วันที่</th>
        			<th>จำนวนเตียงว่างใน Cohort ward</th>
        			<th>จำนวนเตียงว่างใน รพ.สนาม</th>
        			<th>AIIR ที่ว่าง</th>
        			<th>Modified AIIR ที่ว่าง</th>
                    <th>ICU for covid -19 ที่ว่าง</th>
        	...
        	<tbody>
        		...
        		<?php 
        		$sql_table  = "SELECT cah.crvinventoryr4_head_id,cah.crvinventoryr4_head_date,
        (SELECT SUM(cad.cvinvenr4_detail_amount) FROM covid_amount_detail_inventoryr4 cad WHERE cad.cvinvenr4_detail_type = 1 AND cah.crvinventoryr4_head_id = cad.cvinvenr4_head_id) AS CohortWard,
        (SELECT SUM(cad.cvinvenr4_detail_amount) FROM covid_amount_detail_inventoryr4 cad WHERE cad.cvinvenr4_detail_type = 2 AND cah.crvinventoryr4_head_id = cad.cvinvenr4_head_id) AS BedEmpty,
        (SELECT SUM(cad.cvinvenr4_detail_amount) FROM covid_amount_detail_inventoryr4 cad WHERE cad.cvinvenr4_detail_type = 3 AND cah.crvinventoryr4_head_id = cad.cvinvenr4_head_id) AS Aiir,
        (SELECT SUM(cad.cvinvenr4_detail_amount) FROM covid_amount_detail_inventoryr4 cad WHERE cad.cvinvenr4_detail_type = 4 AND cah.crvinventoryr4_head_id = cad.cvinvenr4_head_id) AS ModifiedAirr,
...
$SumEmergency= 0 ;
        		...
        		<tr>
        			<td><?=$numorder?></td>
        			<td><?=thai_date_fullmonth(strtotime($valuetable['crvinventoryr4_head_date']))?></td>
        						<td><?=$valuetable['CohortWard']?></td>
        						<td><?=$valuetable['BedEmpty']?></td>
        						<td><?=$valuetable['Aiir']?></td>
        						<td><?=$valuetable['ModifiedAirr']?></td>   
                                 <td><?=$valuetable['icu_covid']?></td>
                                <td><?=$valuetable['Isolationroom']?></td>
                                   <td><?=$valuetable['Respirator']?></td>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row wow fadeInUp mt-3 mb-0">
                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 clients-img pl-5 pl-lg-5 pl-md-5 pl-sm-5">
                                    <img src="img/red_1.png" alt=""><span> :จำนวนเตียงว่างใน Cohort ward</span>
                                </div>

                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 clients-img pl-5 pl-lg-5 pl-md-5 pl-sm-5">
                                    <img src="img/yellow_1.png" alt=""><span> :จำนวนเตียงว่างใน รพ.สนาม</span>
                                </div>

                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 clients-img pl-5 pl-lg-5 pl-md-5 pl-sm-5">
                                    <img src="img/green_1.png" alt=""><span> :AIIR ที่ว่าง</span>
                                </div>

                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 clients-img pl-5 pl-lg-5 pl-md-5 pl-sm-5">
                                    <img src="img/black_1.png" alt="" width="25px;" height="25px;"><span> :Modified AIIR ที่ว่าง</span>
                                </div>

                               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 clients-img pl-5 pl-lg-5 pl-md-5 pl-sm-5 " >
                                    <img src="img/blue_1.png" alt=""><span> :ICU for covid -19 ที่ว่าง</span>
                                </div>

                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 clients-img pl-5 pl-lg-5 pl-md-5 pl-sm-5">
                                    <img src="img/circle-32.png" alt=""><span> :Isolation room</span>
                                </div>

                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 clients-img pl-5 pl-lg-5 pl-md-5 pl-sm-5">
                                    <img src="img/purple_1.png" alt=""><span> :Respirator</span>
                                </div>
...
var chart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [
       		   {
					label: 'จำนวนเตียงว่างใน Cohort ward ',
					backgroundColor: getRandomColorHex(),
					borderColor:  getRandomColorHex(),
					data:<?=json_encode($CohortWard)?>,
					fill: false,
				}, 
				   {
					label: 'จำนวนเตียงว่างใน รพ.สนาม',
					backgroundColor: getRandomColorHex(),
					borderColor:  getRandomColorHex(),
					data:<?=json_encode($BedEmpty)?>,
					fill: false,
				}, 
				        {
					label: 'AIIR ที่ว่าง',
					backgroundColor: getRandomColorHex(),
					borderColor:  getRandomColorHex(),
					data:<?=json_encode($Aiir)?>,
					fill: false,
				}, 
				        {
					label: 'Modified AIIR ที่ว่าง',
					backgroundColor: getRandomColorHex(),
					borderColor:  getRandomColorHex(),
					data:<?=json_encode($ModifiedAirr)?>,
					fill: false,
				},   {
                    label: 'ICU for covid -19 ที่ว่าง',
                    backgroundColor: getRandomColorHex(),
                    borderColor:  getRandomColorHex(),
                    data:<?=json_encode($icu_covid)?>,
                    fill: false,
                }, 
                        {
                    label: 'Isolation room5',
                    backgroundColor: getRandomColorHex(),
                    borderColor:  getRandomColorHex(),
                    data:<?=json_encode($Isolationroom)?>,
                    fill: false,
                }, 
                        {
                    label: 'Respirator',
    ...
    // Configuration options go here
		options: {
				...
				title: {
					display: true,
					text: 'แผนภมูิแสดงตึก และ ครุภัณฑ์'
				},
				tooltips: {
					mode: 'index',
					intersect: false,
    ...
    <script>
         $(document).ready(function(){
            ...
            function get_GeoJsonSaraburi() {
                        ...
                        MyMap.data.forEach(function(feature) {
                            if(feature.getProperty('SumConfirm') > 0){
                                SumMarker = new google.maps.Marker({
                                    ...
                                    title: 'จำนวนเตียงว่างใน Cohort ward',
                                });
                         ...
                         if(feature.getProperty('Sumicu') > 0){
                                SumMarker = new google.maps.Marker({
                                    position: new google.maps.LatLng(feature.getProperty('lat_icu'), feature.getProperty('lot_icu')),
                                    icon: {
                                        url: "img/blue_1.png",
                                        labelOrigin: new google.maps.Point(12, 13),
                                        //size: new google.maps.Size(32,32),
                                    ...
                                    map: MyMap,
                                    label: {
                                        text: feature.getProperty('Sumicu'),
                                        color: '#fff',
                                        fontSize: '14px',
                                        fontWeight: "bold"
                                    },
                                    title: 'ICU for covid -19 ที่ว่าง',
                                });
                                Marker.push(SumMarker);
                            }
                         if(feature.getProperty('Sumiso') > 0){
                                SumMarker = new google.maps.Marker({
                                    position: new google.maps.LatLng(feature.getProperty('lat_iso'), feature.getProperty('lot_iso')),
                                    icon: {
                                        url: "img/circle-32.png",
                                        labelOrigin: new google.maps.Point(12, 13),
                                        //size: new google.maps.Size(32,32),
                                        //anchor: new google.maps.Point(16,32)
                                    },
                                    map: MyMap,
                                    label: {
                                        text: feature.getProperty('Sumiso'),
                                        color: '#fff',
                                        fontSize: '14px',
                                        fontWeight: "bold"
                                    },
                ...
                if(feature.getProperty('Sumfav') > 0){
                                SumMarker = new google.maps.Marker({
                                    position: new google.maps.LatLng(feature.getProperty('lat_fav'), feature.getProperty('lot_fav')),
                                    icon: {
                                        url: "img/purple_1.png",
                                        labelOrigin: new google.maps.Point(12, 13),
                                        //size: new google.maps.Size(32,32),
                                        //anchor: new google.maps.Point(16,32)
                                    },
                                    map: MyMap,
                                    label: {
                                        text: feature.getProperty('Sumfav'),
                                        color: '#fff',
                                        fontSize: '14px',
                                        fontWeight: "bold"
                                    },
