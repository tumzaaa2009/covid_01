<?php
  ...
  include("../../../include/connect.php");
    ...
    $sql_head = "INSERT INTO covid_amount_head_r4 (cvr4_head_id, cvr4_head_date)
    ...
    if($resultSQL == "1"){
        ...
        for ($i = 0; $i < $SumCol; $i++) {
            ...
            for ($j = 1; $j <= $SumRow; $j++) {
                ...
                $sql_insert_detail = "INSERT INTO covid_amount_detail_r4 SET
                cvr4_head_id = '$cv_head_id',
                cvr4_detail_ampur = '" . $ampur_code . "',
                cvr4_detail_amount = $temp_amount,
                cvr4_detail_type = '" . $columnTypeId[$i] . "'";
