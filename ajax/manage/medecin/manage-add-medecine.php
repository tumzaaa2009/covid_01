<?php
  ...
  include("../../../include/connect.php");
    ...
    $sql_head = "INSERT INTO covid_amount_head_medecine_r4 (crvmedr4_head_id, crvmedr4_head_date)
    ...
    if($resultSQL == "1"){
        ...
        for ($i = 0; $i < $SumCol; $i++) {
            ...
            for ($j = 1; $j <= $SumRow; $j++) {
                ...
                $sql_insert_detail = "INSERT INTO covid_amount_detail_medecine_r4 SET
                cvmedr4_head_id = '$cv_head_id',
                cvmedr4_detail_ampur = '" . $ampur_code . "',
                cvmedr4_detail_amount = $temp_amount,
                cvmedr4_detail_type = '" . $columnTypeId[$i] . "'";
