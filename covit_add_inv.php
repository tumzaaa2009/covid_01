...
?>
                ...
                <div class="row mb-5">
                    <div class="col-lg-12 offset-lg-12">
                        <div class="section-header wow fadeIn" data-wow-duration="1s">
                            <h3 class="section-title"><i class="fas fa-table"></i> ตารางจัดยาและเวชภัณฑ์</h3>
    ...
    <script>
        ...
        function map_get_add() {
            $.ajax({
                type: "POST",
                url: "ajax/manage/inventory/manage-form-add-inv.php",
                dataType: "html",
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function () {
                        ...
                        $.ajax({
                            url: 'ajax/manage/inventory/manage-add-inv.php',
                            type: 'POST',
                            contentType: false,
                            cache: false,
                            processData: false,
        ...
        function Back() {
            window.location.assign("index_inventory.php");
        }
