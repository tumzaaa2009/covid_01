...
?> 
                ...
                <div class="container">
                    <div class="row mb-5">
                        <div class="col-lg-12 offset-lg-12">
                            ...
                            <h3 class="section-title"><i class="fas fa-table"></i>ตารางจัดการ ข้อมูลตึก และ ครุภัณฑ์</h3>
        ...
        <script>
            ...
            function map_get_table(){
                $.ajax({
                    type: "POST",
                    url: "ajax/manage/inventory/manage-table-inv.php",
                    ...
                    buttons: {
                        deleteUser: {
                            ...
                            action: function () {
                                $.ajax({
                                    type: "POST",
                                    url: "ajax/manage/inventory/manage-inv-delete.php",
